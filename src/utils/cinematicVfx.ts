...
export const CRY_STATES_MATRIX: CryStateSpec[] = [
  {
    ...
    pointsValue: 2500,
    description: 'Pawn dips downward (translateY 8px), vibrates with high-frequency micro-jitter, and emits a weeping amber droplet shadow (+2,500 PTS).',
    colorAccent: '#d35400',
    soundType: 'cry_pawn',
  },
  {
    ...
    pointsValue: 2500,
    description: 'Knight horse head rears backward (rotate -25deg), scales up with aggressive hoof stamping and crackling electric blue voltage (+2,500 PTS).',
    colorAccent: '#00d2ff',
  ...
  },
  {
    ...
    pointsValue: 2500,
    description: 'Bishop tilts side-to-side in rhythmic pendulum motion while expanding a radiant golden-violet cross-shaped halo aura (+2,500 PTS).',
    colorAccent: '#8b5cf6',
  ...
  },
  {
    ...
    pointsValue: 2500,
    description: 'Rook castle battlements expand and contract horizontally (scaleX 1.15) simulating a deep horn blast over boiling magma pressure (+2,500 PTS).',
    colorAccent: '#ef4444',
    soundType: 'cry_rook',
  },
  {
    ...
    pointsValue: 2500,
    description: 'Queen floats vertically upward (translateY -12px), discharging triple-tier shockwave ripple rings and blinding golden-white corona (+2,500 PTS).',
    colorAccent: '#ffd700',
    soundType: 'cry_queen',
  },
  {
    ...
    pointsValue: 2500,
    description: 'King bows slightly before thrusting crown upward (translateY -8px, scale 1.15) unleashing a magnificent platinum-gold royal shield (+2,500 PTS).',
    colorAccent: '#fbbf24',
    soundType: 'cry_king',
  },
];
...
/**
 * Trigger an exclusive 2,500 PTS Cry State for a piece
 */
